  ...
  return {
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getWaitingVerification(options);
...
export const AdminApiFactory = function (
  ...
  return {
    ...
    getWaitingVerification(options?: any): AxiosPromise<Array<Admin>> {
      return localVarFp
        .getWaitingVerification(options)
...
export const AuthApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.googleAuth(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.googleAuthRedirect(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
 ...
 * @export
 */
export const VideoApiAxiosParamCreator = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    deleteVideo: async (
      ...
      const localVarPath = `/api/video/{id}`.replace(
        `{${'id'}}`,
     ...
     * @throws {RequiredError}
     */
    getVideoPreviewDetail: async (
      id: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('getVideoPreviewDetail', 'id', id);
      const localVarPath = `/api/video/preview/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    updateVideosFromYoutubeApi: async (
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      const localVarPath = `/api/video`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
...
export const VideoApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addVideo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addVideo(
        addVideoRequest,
        options
      );
      return createRequestFunction(
    ...
    async deleteVideo(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteVideo(
        id,
        options
      );
      return createRequestFunction(
     ...
     * @throws {RequiredError}
     */
    async getVideoPreviewDetail(
      id: string,
      options?: AxiosRequestConfig
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Video>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getVideoPreviewDetail(id, options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getVideos(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<Video>>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getVideos(
        options
      );
      return createRequestFunction(
        localVarAxiosArgs,
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.updateVideosFromYoutubeApi(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
...
export const VideoApiFactory = function (
  ...
  return {
    ...
    addVideo(
      ...
      return localVarFp
        .addVideo(addVideoRequest, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    getVideoPreviewDetail(id: string, options?: any): AxiosPromise<Video> {
      return localVarFp
        .getVideoPreviewDetail(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    updateVideosFromYoutubeApi(options?: any): AxiosPromise<void> {
      return localVarFp
        .updateVideosFromYoutubeApi(options)
        .then((request) => request(axios, basePath));
    },
  };
};
